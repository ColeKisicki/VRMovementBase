...
%ADB% %DEVICE% install VRBase-Android-Shipping_universal.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell pm list packages com.CK.VRMovement
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.CK.VRMovement
